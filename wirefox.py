...
\033[92m.mMMm`MMMMMMMMMMMMMMMMMMMM`mMMm.            \033[0m Thanks for downloading!\033[92m {1}by ANON_G FOX
...
logo_design_7 = Fore.GREEN + '''
    ...
    OOOOO                 '"OOOOOOOOOOOOOOOO"`                oOO               {1}by ANON_G FOX
